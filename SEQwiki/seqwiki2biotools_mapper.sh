...
#python2 seqwiki2biotools.py -tool tools.csv -ref references.csv -url urls.csv -edam EDAM.csv -mix 1 | sort > seqwiki_mixed_concepts_sorted.txt

# Print the mismatching concepts to a file:
#python2 seqwiki2biotools.py -tool tools.csv -ref references.csv -url urls.csv -edam EDAM.csv -mis 1 | sort > seqwiki_mismatching_concepts_sorted.txt

# Print the missing tool names to a file:
#python2 seqwiki2biotools.py -tool tools.csv -ref references.csv -url urls.csv -edam EDAM.csv -nokey 1 > seqwiki_missing_tool_names.txt

# Dump the tools in JSON format and XML
python2 seqwiki2biotools.py -tool tools.csv -ref references.csv -url urls.csv -edam EDAM.csv -out seqwiki_dump.json -stats seqwiki_dump.stats -v 1
